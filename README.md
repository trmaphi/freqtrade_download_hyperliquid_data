...
**DISCLAIMER**: the source code originally from https://github.com/FrequentHippos/freqtrade_hyperliquid_download-data. I only do some maintenance work
...
1. **Clone this repository**:
   ```bash
   git clone https://github.com/trmaphi/freqtrade_download_hyperliquid_data.git
